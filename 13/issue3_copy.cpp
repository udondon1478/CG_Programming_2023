// g++ -O3 issue3.cpp -framework OpenGL -framework GLUT -Wno-deprecated
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
#include <math.h>
...
Vec_3D vectorNormalize(Vec_3D wwwwwwwrrrrrwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwvec);
...
void display()
{
    ...
    glVertex3d(jData[fID][6].x, jData[fID][6].y, jData[fID][6].z);
    glVertex3d(jData[fID][2].x, jData[fID][2].y, jData[fID][2].z);
    glVertex3d(jData[fID][3].x, jData[fID][3].y, jData[fID][3].z);
    glEnd();



    //胴体の三角形面の法線に垂直でjData[fID][2]を通る長方形を描画
    ...
    glVertex3d(jData[fID][12].x, jData[fID][12].y, jData[fID][12].z);
    glTexCoord2d(1.0, 1.0);
    glVertex3d(jData[fID][9].x , jData[fID][9].y , jData[fID][9].z);
