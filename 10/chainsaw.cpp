// g++ chainsaw.cpp -framework OpenGL -framework GLUT -Wno-deprecated
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <GLUT/glut.h>        //OpenGL/GLUT
//opencvをinclude
#include </opt/homebrew/Cellar/opencv/4.8.1_5/include/opencv4/opencv2/opencv.hpp> //OpenCV
...
void initGL()
{
    ...
    eDist = 120.0; // 距離
    eDegX = 15.0;
    eDegY = 0.0; // x軸周り角度，y軸周り角度

    // テクスチャ準備
    cv::Mat textureImage; // テクスチャ画像格納用
    // テクスチャ 0 作成
    textureImage = cv::imread("chainsaw.jpg", cv::IMREAD_UNCHANGED);                                                                // 画像読み込み
