...
void display()
{
    ...
    //左太ももの正面
    //色変更
    GLfloat thighCol[4], thighSpe[4], thighShi[1];
    thighCol[0] = 1.0; thighCol[1] = 0.0; thighCol[2] = 0.0; thighCol[3] = 1.0;
    thighSpe[0] = 1.0; thighSpe[1] = 1.0; thighSpe[2] = 1.0; thighSpe[3] = 1.0;
    thighShi[0] = 50;
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT_AND_DIFFUSE, thighCol);
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, thighSpe);
    glMaterialfv(GL_FRONT_AND_BACK, GL_SHININESS, thighShi);
...
void drawEffectRight() {
  //jData[fID][13]の座標を中心に一辺50の立方体を描画
    ...
    effectCol[0] = 1.0; effectCol[1] = 0.0; effectCol[2] = 0.0; effectCol[3] = 1.0;
    effectSpe[0] = 1.0; effectSpe[1] = 1.0; effectSpe[2] = 1.0; effectSpe[3] = 1.0;
    effectShi[0] = 50;
